...
public abstract class APIHandler {
	...
	public void accepted(Buffer buffer) {
	...
	public void badGateway(Buffer buffer) {
	...
	public void badRequest(Buffer buffer) {
	...
	public void conflict(Buffer buffer) {
	...
	public void continueIt(Buffer buffer) {
	...
	public void created(Buffer buffer) {
	...
	public void error(Buffer buffer) {
	...
	public void error(Object object, Charset charset) {
	...
	public void error(String content, Charset charset) {
	...
	public void expectationFailed(Buffer buffer) {
	...
	public void failedDependency(Buffer buffer) {
	...
	public void forbidden(Buffer buffer) {
	...
	public void found(Buffer buffer) {
	...
	public void gatewayTimeout(Buffer buffer) {
	...
	public void gone(Buffer buffer) {
	...
	public void httpVersionNotSupported(Buffer buffer) {
	...
	public void insufficientStorage(Buffer buffer) {
	...
	public void internalServerError(Buffer buffer) {
	...
	public void lengthRequired(Buffer buffer) {
	...
	public void locked(Buffer buffer) {
	...
	public void methodNotAllowed(Buffer buffer) {
	...
	public void misdirectedRequest(Buffer buffer) {
	...
	public void movedPermanently(Buffer buffer) {
	...
	public void multipleChoices(Buffer buffer) {
	...
	public void multiStatus(Buffer buffer) {
	...
	public void networkAuthenticationRequired(Buffer buffer) {
	...
	public void noContent(Buffer buffer) {
	...
	public void nonAuthoratitativeInformation() {
		status(HttpResponseStatus.NON_AUTHORITATIVE_INFORMATION).end();
	}

	public void nonAuthoratitativeInformation(Buffer buffer) {
	...
	public void notAcceptable(Buffer buffer) {
	...
	public void notExtended(Buffer buffer) {
	...
	public void notFound(Buffer buffer) {
	...
	public void notImplemented(Buffer buffer) {
	...
	public void notModified(Buffer buffer) {
	...
	public void ok(Object object, Charset charset) {
	...
	public void ok(String content, Charset charset) {
	...
	public void partialContent(Buffer buffer) {
	...
	public void paymentRequired(Buffer buffer) {
	...
	public void preConditionFailed(Buffer buffer) {
	...
	public void preconditionRequired(Buffer buffer) {
	...
	public void processing(Buffer buffer) {
	...
	public void proxyAuthenticationRequired(Buffer buffer) {
	...
	public void requestEntityTooLarge() {
		status(HttpResponseStatus.REQUEST_ENTITY_TOO_LARGE).end();
	}

	public void requestEntityTooLarge(Buffer buffer) {
	...
	public void requestHeaderFieldsTooLarge(Buffer buffer) {
	...
	public void requestRangeNotSatisfiable(Buffer buffer) {
	...
	public void requestTimeout(Buffer buffer) {
	...
	public void requestUtiTooLong() {
		status(HttpResponseStatus.REQUEST_ENTITY_TOO_LARGE).end();
	}

	public void requestUtiTooLong(Buffer buffer) {
		status(HttpResponseStatus.REQUEST_ENTITY_TOO_LARGE).end(buffer);
	}
	...
	public void resetContent(Buffer buffer) {
	...
	public void seeOther(Buffer buffer) {
	...
	public void serviceUnavailable(Buffer buffer) {
	...
	public void success(Object object, Charset charset) {
	...
	public void success(String content, Charset charset) {
		status(HttpResponseStatus.OK);
		if (isValidJson(content)) {
			contentType("application/json");
		}
	...
	public void switchingProtocols() {
		status(HttpResponseStatus.SWITCHING_PROTOCOLS).end();
	}

	public void switchingProtocols(Buffer buffer) {
	...
	public void temporaryRedirect(Buffer buffer) {
	...
	public void tooManyRequest(Buffer buffer) {
	...
	public void unauthorized(Buffer buffer) {
	...
	public void unorderedCollection() {
		status(HttpResponseStatus.UNORDERED_COLLECTION).end();
	}

	public void unorderedCollection(Buffer buffer) {
	...
	public void unprocessableEntity(Buffer buffer) {
	...
	public void unsupportedMediaType(Buffer buffer) {
	...
	public void upgradeRequired(Buffer buffer) {
	...
	public void useProxy(Buffer buffer) {
	...
	public void variantAlsoNegotiates(Buffer buffer) {
