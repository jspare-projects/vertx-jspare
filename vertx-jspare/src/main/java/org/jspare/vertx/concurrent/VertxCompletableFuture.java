...
public class VertxCompletableFuture<T> extends CompletableFuture<T> implements CompletionStage<T> {
	...
	/**
	 * Creates a {@link VertxCompletableFuture} from the given {@link Context}
	 * and {@link CompletableFuture}.
	 * <p>
	 * The created {@link VertxCompletableFuture} is completed successfully or
	 * not when the given future completes successfully or not. The completion
	 * is called on the given {@link Context}, immediately if it is already
	...
	/**
	 * Creates a new {@link VertxCompletableFuture} from the given
	 * {@link Context} instance and given {@link Future}. The returned future
	 * uses the current Vert.x context, or creates a new one.
	 * <p>
	 * The created {@link VertxCompletableFuture} is completed successfully or
	 * not when the given future completes successfully or not. The created
	 * {@link VertxCompletableFuture} is completed successfully or not when the
	 * given future completes successfully or not. The completion is called on
	 * the given {@link Context}, immediately if it is already executing on the
	 * right context, asynchronously if not.
	 *
	 * @param context
	 *            the context
	 * @param future
	 ...
	 * instance and given {@link CompletableFuture}. The returned future uses
	 * the current Vert.x context, or creates a new one.
	 * <p>
	 * The created {@link VertxCompletableFuture} is completed successfully or
	 * not when the given completable future completes successfully or not.
	 *
	 * @param vertx
	 *            the Vert.x instance
	 * @param future
	 ...
	 * <p>
	 * The created {@link VertxCompletableFuture} is completed successfully or
	 * not when the given future completes successfully or not.
	 *
	 * @param vertx
	 *            the Vert.x instance
	 * @param future
	 ...
	 * task running in the current Vert.x {@link Context} after it runs the
	 * given action.
	 * <p>
	 * This method is different from
	 * {@link CompletableFuture#runAsync(Runnable)} as it does not use a fork
	 ...
	 *            returned CompletableFuture. If the execution throws an
	 *            exception, the returned CompletableFuture is completed
	 *            exceptionally.
	 * @return the new CompletableFuture
	 */
	...
	/**
	 * Returns a new CompletableFuture that is asynchronously completed by a
	 * task running in the current Vert.x {@link Context} with the value
	...
	/**
	 * Returns a new CompletableFuture that is asynchronously completed by a
	 * task running in the worker thread pool of Vert.x
	 * <p>
	 * This method is different from
	 * {@link CompletableFuture#supplyAsync(Supplier)} as it does not use a fork
	 * join executor, but the worker thread pool.
	 ...
	 * given {@link CompletableFuture}. The created
	 * {@link VertxCompletableFuture} is completed successfully or not when the
	 * given completable future completes successfully or not.
	 *
	 * @param context
	 *            the context
	 * @param future
	...
	/**
	 * Creates a new {@link VertxCompletableFuture} using the given context.
	 * This method is used to switch between Vert.x contexts.
	 *
	 * @param context
	 *            the context
